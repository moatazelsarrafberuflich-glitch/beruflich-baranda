...
import { MenuCardIcon } from "../../lib/menuIconRegistry";
...
export default function MenuScreen() {
  ...
  // ↔ item.actionValue بييجي من نص حر بيكتبه الأدمن فى لوحة التحكم
  // (AdminMenuItems.tsx، من غير أي تحقق من صحة المسار) ويتحط مباشرة فى
  // router.push() جوه معالج اللمسة نفسه. أي غلطة إملائية بسيطة فى المسار
  // (مسافة زيادة، حرف كبير/صغير، ناقص شرطة مائلة...) ممكن تخلي التنقل
  // يرمي استثناء وقت الضغط بالظبط — واللي بيوصل لغياب أي شاشة "غير موجود"
  // ويطلع كأن التطبيق قفل فجأة. الـ try/catch هنا مش بيغيّر أي سلوك طبيعي
  // (لو المسار صحيح هيشتغل زي ما هو بالظبط)، بس بيمنع أي مسار فيه غلطة
  // إملائية من إسقاط الشاشة كلها، وبيوضح للمستخدم رسالة مفهومة بدلها.
            ...
            return (
              <View key={row.tall.id + "-tall"} style={styles.row}>
                ...
                >
                  ...
                  <MenuCardIcon iconKey={row.tall.iconKey} height={82} color={tallTextColor} />
                </Pressable>
